...
use DeckTransitionType;
use NavigationDirection;
use Swipeable;

glib_wrapper! {
    pub struct Deck(Object<handy_sys::HdyDeck, handy_sys::HdyDeckClass, DeckClass>) @extends gtk::Container, gtk::Widget, @implements gtk::Buildable, gtk::Orientable, Swipeable;

    match fn {
        get_type => || handy_sys::hdy_deck_get_type(),
    }
}
...
impl Deck {
    pub fn new() -> Deck {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_deck_new()).unsafe_cast() }
    }
}
...
pub struct DeckBuilder {
    ...
    transition_type: Option<DeckTransitionType>,
...
impl DeckBuilder {
    ...
    pub fn build(self) -> Deck {
        ...
        let ret = glib::Object::new(Deck::static_type(), &properties)
            .expect("object new")
            .downcast::<Deck>()
            .expect("downcast");
        ret
    ...
    pub fn transition_type(mut self, transition_type: DeckTransitionType) -> Self {
...
pub const NONE_DECK: Option<&Deck> = None;

pub trait DeckExt: 'static {
    ...
    fn get_homogeneous(&self, orientation: gtk::Orientation) -> bool;
    ...
    fn get_transition_type(&self) -> DeckTransitionType;
    ...
    fn set_homogeneous(&self, orientation: gtk::Orientation, homogeneous: bool);
    ...
    fn get_property_hhomogeneous(&self) -> bool;

    fn set_property_hhomogeneous(&self, hhomogeneous: bool);

    fn get_property_vhomogeneous(&self) -> bool;
...
impl<O: IsA<Deck>> DeckExt for O {
    fn get_adjacent_child(&self, direction: NavigationDirection) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(handy_sys::hdy_deck_get_adjacent_child(
    ...
    fn get_can_swipe_back(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_deck_get_can_swipe_back(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_can_swipe_forward(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_deck_get_can_swipe_forward(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_child_by_name(&self, name: &str) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(handy_sys::hdy_deck_get_child_by_name(
                self.as_ref().to_glib_none().0,
                name.to_glib_none().0,
            ))
        }
    ...
    fn get_homogeneous(&self, orientation: gtk::Orientation) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_deck_get_homogeneous(
                self.as_ref().to_glib_none().0,
                orientation.to_glib(),
            ))
        }
    ...
    fn get_interpolate_size(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_deck_get_interpolate_size(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_transition_duration(&self) -> u32 {
        unsafe { handy_sys::hdy_deck_get_transition_duration(self.as_ref().to_glib_none().0) }
    }

    fn get_transition_running(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_deck_get_transition_running(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_transition_type(&self) -> DeckTransitionType {
        unsafe {
            from_glib(handy_sys::hdy_deck_get_transition_type(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_visible_child(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(handy_sys::hdy_deck_get_visible_child(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_visible_child_name(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_deck_get_visible_child_name(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn navigate(&self, direction: NavigationDirection) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_deck_navigate(
                self.as_ref().to_glib_none().0,
                direction.to_glib(),
            ))
        }
    ...
    fn set_can_swipe_back(&self, can_swipe_back: bool) {
        unsafe {
            handy_sys::hdy_deck_set_can_swipe_back(
                self.as_ref().to_glib_none().0,
    ...
    fn set_can_swipe_forward(&self, can_swipe_forward: bool) {
        unsafe {
            handy_sys::hdy_deck_set_can_swipe_forward(
                self.as_ref().to_glib_none().0,
    ...
    fn set_homogeneous(&self, orientation: gtk::Orientation, homogeneous: bool) {
        unsafe {
            handy_sys::hdy_deck_set_homogeneous(
                self.as_ref().to_glib_none().0,
                orientation.to_glib(),
                homogeneous.to_glib(),
            );
    ...
    fn set_interpolate_size(&self, interpolate_size: bool) {
        unsafe {
            handy_sys::hdy_deck_set_interpolate_size(
                self.as_ref().to_glib_none().0,
    ...
    fn set_transition_duration(&self, duration: u32) {
        unsafe {
            handy_sys::hdy_deck_set_transition_duration(self.as_ref().to_glib_none().0, duration);
        }
    }

    fn set_transition_type(&self, transition: DeckTransitionType) {
        unsafe {
            handy_sys::hdy_deck_set_transition_type(
                self.as_ref().to_glib_none().0,
                transition.to_glib(),
            );
        }
    ...
    fn set_visible_child<P: IsA<gtk::Widget>>(&self, visible_child: &P) {
        unsafe {
            handy_sys::hdy_deck_set_visible_child(
                self.as_ref().to_glib_none().0,
    ...
    fn set_visible_child_name(&self, name: &str) {
        unsafe {
            handy_sys::hdy_deck_set_visible_child_name(
                self.as_ref().to_glib_none().0,
                name.to_glib_none().0,
            );
        }
    ...
    fn get_property_hhomogeneous(&self) -> bool {
        unsafe {
            ...
            gobject_sys::g_object_get_property(
                ...
                b"hhomogeneous\0".as_ptr() as *const _,
                value.to_glib_none_mut().0,
            );
            value
                .get()
                .expect("Return Value for property `hhomogeneous` getter")
                .unwrap()
        }
    }
    ...
    fn set_property_hhomogeneous(&self, hhomogeneous: bool) {
        unsafe {
            gobject_sys::g_object_set_property(
                self.to_glib_none().0 as *mut gobject_sys::GObject,
                b"hhomogeneous\0".as_ptr() as *const _,
                Value::from(&hhomogeneous).to_glib_none().0,
            );
        }
    }
    ...
    fn get_property_vhomogeneous(&self) -> bool {
        unsafe {
            ...
            gobject_sys::g_object_get_property(
                self.to_glib_none().0 as *mut gobject_sys::GObject,
                b"vhomogeneous\0".as_ptr() as *const _,
                value.to_glib_none_mut().0,
            );
            value
                .get()
                .expect("Return Value for property `vhomogeneous` getter")
                .unwrap()
        }
    }
    ...
    fn set_property_vhomogeneous(&self, vhomogeneous: bool) {
        unsafe {
            gobject_sys::g_object_set_property(
                self.to_glib_none().0 as *mut gobject_sys::GObject,
                b"vhomogeneous\0".as_ptr() as *const _,
                Value::from(&vhomogeneous).to_glib_none().0,
            );
        }
    }
    ...
    fn connect_property_can_swipe_back_notify<F: Fn(&Self) + 'static>(
            ...
            P: IsA<Deck>,
        {
            ...
            f(&Deck::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
