...
impl SearchBar {
    pub fn new() -> SearchBar {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_search_bar_new()).unsafe_cast() }
    }
}
...
impl<O: IsA<SearchBar>> SearchBarExt for O {
    fn connect_entry<P: IsA<gtk::Entry>>(&self, entry: &P) {
        unsafe {
            handy_sys::hdy_search_bar_connect_entry(
    ...
    fn get_search_mode(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_search_bar_get_search_mode(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_show_close_button(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_search_bar_get_show_close_button(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn handle_event(&self, event: &mut gdk::Event) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_search_bar_handle_event(
                self.as_ref().to_glib_none().0,
    ...
    fn set_search_mode(&self, search_mode: bool) {
        unsafe {
            handy_sys::hdy_search_bar_set_search_mode(
                self.as_ref().to_glib_none().0,
                search_mode.to_glib(),
            );
        }
    ...
    fn set_show_close_button(&self, visible: bool) {
        unsafe {
            handy_sys::hdy_search_bar_set_show_close_button(
                self.as_ref().to_glib_none().0,
                visible.to_glib(),
            );
        }
    ...
    fn connect_property_search_mode_enabled_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_search_mode_enabled_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut handy_sys::HdySearchBar,
