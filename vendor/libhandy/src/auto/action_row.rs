...
impl ActionRow {
    pub fn new() -> ActionRow {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_action_row_new()).unsafe_cast() }
    }
}
...
impl<O: IsA<ActionRow>> ActionRowExt for O {
    ...
    fn add_prefix<P: IsA<gtk::Widget>>(&self, widget: &P) {
        unsafe {
            handy_sys::hdy_action_row_add_prefix(
    ...
    fn get_activatable_widget(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(handy_sys::hdy_action_row_get_activatable_widget(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_icon_name(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_action_row_get_icon_name(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_subtitle(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_action_row_get_subtitle(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_activatable_widget<P: IsA<gtk::Widget>>(&self, widget: Option<&P>) {
        unsafe {
            handy_sys::hdy_action_row_set_activatable_widget(
                self.as_ref().to_glib_none().0,
    ...
    fn set_icon_name(&self, icon_name: &str) {
        unsafe {
            handy_sys::hdy_action_row_set_icon_name(
                self.as_ref().to_glib_none().0,
    ...
    fn set_subtitle(&self, subtitle: Option<&str>) {
        unsafe {
            handy_sys::hdy_action_row_set_subtitle(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_activated<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn activated_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut handy_sys::HdyActionRow,
            f: glib_sys::gpointer,
        ) where
            P: IsA<ActionRow>,
        {
