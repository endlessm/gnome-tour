...
impl TitleBar {
    pub fn new() -> TitleBar {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_title_bar_new()).unsafe_cast() }
    }
}
...
impl TitleBarBuilder {
    ...
    pub fn build(self) -> TitleBar {
        ...
        let ret = glib::Object::new(TitleBar::static_type(), &properties)
            .expect("object new")
            .downcast::<TitleBar>()
            .expect("downcast");
        ret
    ...
    pub fn selection_mode(mut self, selection_mode: bool) -> Self {
...
impl<O: IsA<TitleBar>> TitleBarExt for O {
    fn get_selection_mode(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_title_bar_get_selection_mode(
    ...
    fn set_selection_mode(&self, selection_mode: bool) {
        unsafe {
            handy_sys::hdy_title_bar_set_selection_mode(
                self.as_ref().to_glib_none().0,
                selection_mode.to_glib(),
            );
        }
    }
    ...
    fn connect_property_selection_mode_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_selection_mode_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut handy_sys::HdyTitleBar,
            ...
            P: IsA<TitleBar>,
        {
            ...
            f(&TitleBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
