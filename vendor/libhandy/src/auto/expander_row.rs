...
glib_wrapper! {
    pub struct ExpanderRow(Object<handy_sys::HdyExpanderRow, handy_sys::HdyExpanderRowClass, ExpanderRowClass>) @extends PreferencesRow, gtk::ListBoxRow, gtk::Bin, gtk::Container, gtk::Widget, @implements gtk::Buildable, gtk::Actionable;
...
impl ExpanderRow {
    pub fn new() -> ExpanderRow {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_expander_row_new()).unsafe_cast() }
    }
}
...
impl<O: IsA<ExpanderRow>> ExpanderRowExt for O {
    fn add_action<P: IsA<gtk::Widget>>(&self, widget: &P) {
        unsafe {
            handy_sys::hdy_expander_row_add_action(
    ...
    fn add_prefix<P: IsA<gtk::Widget>>(&self, widget: &P) {
        unsafe {
            handy_sys::hdy_expander_row_add_prefix(
                self.as_ref().to_glib_none().0,
                widget.as_ref().to_glib_none().0,
            );
        }
    ...
    fn get_enable_expansion(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_expander_row_get_enable_expansion(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_expanded(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_expander_row_get_expanded(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_icon_name(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_expander_row_get_icon_name(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_show_enable_switch(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_expander_row_get_show_enable_switch(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_subtitle(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_expander_row_get_subtitle(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_enable_expansion(&self, enable_expansion: bool) {
        unsafe {
            handy_sys::hdy_expander_row_set_enable_expansion(
                self.as_ref().to_glib_none().0,
    ...
    fn set_expanded(&self, expanded: bool) {
        unsafe {
            handy_sys::hdy_expander_row_set_expanded(
                self.as_ref().to_glib_none().0,
                expanded.to_glib(),
            );
        }
    ...
    fn set_icon_name(&self, icon_name: &str) {
        unsafe {
            handy_sys::hdy_expander_row_set_icon_name(
                self.as_ref().to_glib_none().0,
    ...
    fn set_show_enable_switch(&self, show_enable_switch: bool) {
        unsafe {
            handy_sys::hdy_expander_row_set_show_enable_switch(
                self.as_ref().to_glib_none().0,
    ...
    fn set_subtitle(&self, subtitle: Option<&str>) {
        unsafe {
            handy_sys::hdy_expander_row_set_subtitle(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_enable_expansion_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_enable_expansion_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut handy_sys::HdyExpanderRow,
