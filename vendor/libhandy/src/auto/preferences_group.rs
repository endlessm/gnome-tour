...
glib_wrapper! {
    pub struct PreferencesGroup(Object<handy_sys::HdyPreferencesGroup, handy_sys::HdyPreferencesGroupClass, PreferencesGroupClass>) @extends gtk::Bin, gtk::Container, gtk::Widget, @implements gtk::Buildable;
...
impl PreferencesGroup {
    pub fn new() -> PreferencesGroup {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_preferences_group_new()).unsafe_cast() }
    }
}
...
impl PreferencesGroupBuilder {
    ...
    pub fn build(self) -> PreferencesGroup {
        ...
        let ret = glib::Object::new(PreferencesGroup::static_type(), &properties)
            .expect("object new")
            .downcast::<PreferencesGroup>()
            .expect("downcast");
        ret
    }
...
impl<O: IsA<PreferencesGroup>> PreferencesGroupExt for O {
    fn get_description(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_preferences_group_get_description(
    ...
    fn get_title(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_preferences_group_get_title(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_description(&self, description: &str) {
        unsafe {
            handy_sys::hdy_preferences_group_set_description(
                self.as_ref().to_glib_none().0,
    ...
    fn set_title(&self, title: &str) {
        unsafe {
            handy_sys::hdy_preferences_group_set_title(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_description_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut handy_sys::HdyPreferencesGroup,
