...
impl HeaderBar {
    pub fn new() -> HeaderBar {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_header_bar_new()).unsafe_cast() }
    }
}
...
impl HeaderBarBuilder {
    ...
    pub fn build(self) -> HeaderBar {
        ...
        if let Some(ref centering_policy) = self.centering_policy {
            properties.push(("centering-policy", centering_policy));
        }
    ...
    pub fn centering_policy(mut self, centering_policy: CenteringPolicy) -> Self {
        self.centering_policy = Some(centering_policy);
        self
    }

    pub fn custom_title<P: IsA<gtk::Widget>>(mut self, custom_title: &P) -> Self {
...
pub trait HeaderBarExt: 'static {
    ...
    fn connect_property_centering_policy_notify<F: Fn(&Self) + 'static>(
        &self,
        f: F,
    ) -> SignalHandlerId;
...
impl<O: IsA<HeaderBar>> HeaderBarExt for O {
    fn get_centering_policy(&self) -> CenteringPolicy {
        unsafe {
            from_glib(handy_sys::hdy_header_bar_get_centering_policy(
    ...
    fn get_custom_title(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(handy_sys::hdy_header_bar_get_custom_title(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_decoration_layout(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_header_bar_get_decoration_layout(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_has_subtitle(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_header_bar_get_has_subtitle(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_interpolate_size(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_header_bar_get_interpolate_size(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_show_close_button(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_header_bar_get_show_close_button(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_subtitle(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_header_bar_get_subtitle(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_title(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_header_bar_get_title(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_transition_duration(&self) -> u32 {
        unsafe { handy_sys::hdy_header_bar_get_transition_duration(self.as_ref().to_glib_none().0) }
    }

    fn get_transition_running(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_header_bar_get_transition_running(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn pack_end<P: IsA<gtk::Widget>>(&self, child: &P) {
        unsafe {
            handy_sys::hdy_header_bar_pack_end(
                self.as_ref().to_glib_none().0,
    ...
    fn pack_start<P: IsA<gtk::Widget>>(&self, child: &P) {
        unsafe {
            handy_sys::hdy_header_bar_pack_start(
                self.as_ref().to_glib_none().0,
                child.as_ref().to_glib_none().0,
            );
        }
    ...
    fn set_centering_policy(&self, centering_policy: CenteringPolicy) {
        unsafe {
            handy_sys::hdy_header_bar_set_centering_policy(
                self.as_ref().to_glib_none().0,
    ...
    fn set_custom_title<P: IsA<gtk::Widget>>(&self, title_widget: Option<&P>) {
        unsafe {
            handy_sys::hdy_header_bar_set_custom_title(
                self.as_ref().to_glib_none().0,
    ...
    fn set_decoration_layout(&self, layout: Option<&str>) {
        unsafe {
            handy_sys::hdy_header_bar_set_decoration_layout(
                self.as_ref().to_glib_none().0,
    ...
    fn set_has_subtitle(&self, setting: bool) {
        unsafe {
            handy_sys::hdy_header_bar_set_has_subtitle(
                self.as_ref().to_glib_none().0,
                setting.to_glib(),
            );
        }
    ...
    fn set_interpolate_size(&self, interpolate_size: bool) {
        unsafe {
            handy_sys::hdy_header_bar_set_interpolate_size(
                self.as_ref().to_glib_none().0,
    ...
    fn set_show_close_button(&self, setting: bool) {
        unsafe {
            handy_sys::hdy_header_bar_set_show_close_button(
                self.as_ref().to_glib_none().0,
                setting.to_glib(),
            );
        }
    ...
    fn set_subtitle(&self, subtitle: Option<&str>) {
        unsafe {
            handy_sys::hdy_header_bar_set_subtitle(
                self.as_ref().to_glib_none().0,
    ...
    fn set_title(&self, title: Option<&str>) {
        unsafe {
            handy_sys::hdy_header_bar_set_title(
                self.as_ref().to_glib_none().0,
    ...
    fn set_transition_duration(&self, duration: u32) {
        unsafe {
            handy_sys::hdy_header_bar_set_transition_duration(
                self.as_ref().to_glib_none().0,
                duration,
            );
        }
    ...
    fn connect_property_centering_policy_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_centering_policy_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut handy_sys::HdyHeaderBar,
