...
glib_wrapper! {
    pub struct ViewSwitcher(Object<handy_sys::HdyViewSwitcher, handy_sys::HdyViewSwitcherClass, ViewSwitcherClass>) @extends gtk::Bin, gtk::Container, gtk::Widget, @implements gtk::Buildable;
...
impl ViewSwitcher {
    pub fn new() -> ViewSwitcher {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_view_switcher_new()).unsafe_cast() }
    }
}
...
impl ViewSwitcherBuilder {
    ...
    pub fn build(self) -> ViewSwitcher {
        ...
        let ret = glib::Object::new(ViewSwitcher::static_type(), &properties)
            .expect("object new")
            .downcast::<ViewSwitcher>()
            .expect("downcast");
        ret
    }
...
impl<O: IsA<ViewSwitcher>> ViewSwitcherExt for O {
    ...
    fn get_policy(&self) -> ViewSwitcherPolicy {
        unsafe {
            from_glib(handy_sys::hdy_view_switcher_get_policy(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_stack(&self) -> Option<gtk::Stack> {
        unsafe {
            from_glib_none(handy_sys::hdy_view_switcher_get_stack(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_policy(&self, policy: ViewSwitcherPolicy) {
        unsafe {
            handy_sys::hdy_view_switcher_set_policy(
                self.as_ref().to_glib_none().0,
                policy.to_glib(),
            );
        }
    ...
    fn set_stack<P: IsA<gtk::Stack>>(&self, stack: Option<&P>) {
        unsafe {
            handy_sys::hdy_view_switcher_set_stack(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_narrow_ellipsize_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_narrow_ellipsize_trampoline<P, F: Fn(&P) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute::<_, unsafe extern "C" fn()>(
                    notify_narrow_ellipsize_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
