...
impl ViewSwitcherBar {
    pub fn new() -> ViewSwitcherBar {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_view_switcher_bar_new()).unsafe_cast() }
    }
}
...
impl ViewSwitcherBarBuilder {
    ...
    pub fn build(self) -> ViewSwitcherBar {
        ...
        let ret = glib::Object::new(ViewSwitcherBar::static_type(), &properties)
            .expect("object new")
            .downcast::<ViewSwitcherBar>()
            .expect("downcast");
        ret
    }
...
impl<O: IsA<ViewSwitcherBar>> ViewSwitcherBarExt for O {
    ...
    fn get_reveal(&self) -> bool {
        unsafe {
            from_glib(handy_sys::hdy_view_switcher_bar_get_reveal(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_stack(&self) -> Option<gtk::Stack> {
        unsafe {
            from_glib_none(handy_sys::hdy_view_switcher_bar_get_stack(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_reveal(&self, reveal: bool) {
        unsafe {
            handy_sys::hdy_view_switcher_bar_set_reveal(
                self.as_ref().to_glib_none().0,
                reveal.to_glib(),
            );
        }
    ...
    fn set_stack<P: IsA<gtk::Stack>>(&self, stack: Option<&P>) {
        unsafe {
            handy_sys::hdy_view_switcher_bar_set_stack(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_reveal_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_reveal_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut handy_sys::HdyViewSwitcherBar,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute::<_, unsafe extern "C" fn()>(
                    notify_reveal_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
