...
glib_wrapper! {
    pub struct PreferencesPage(Object<handy_sys::HdyPreferencesPage, handy_sys::HdyPreferencesPageClass, PreferencesPageClass>) @extends gtk::Bin, gtk::Container, gtk::Widget, @implements gtk::Buildable;
...
impl PreferencesPage {
    pub fn new() -> PreferencesPage {
        ...
        unsafe { gtk::Widget::from_glib_none(handy_sys::hdy_preferences_page_new()).unsafe_cast() }
    }
}
...
impl PreferencesPageBuilder {
    ...
    pub fn build(self) -> PreferencesPage {
        ...
        let ret = glib::Object::new(PreferencesPage::static_type(), &properties)
            .expect("object new")
            .downcast::<PreferencesPage>()
            .expect("downcast");
        ret
    }
...
impl<O: IsA<PreferencesPage>> PreferencesPageExt for O {
    fn get_icon_name(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_preferences_page_get_icon_name(
    ...
    fn get_title(&self) -> Option<GString> {
        unsafe {
            from_glib_none(handy_sys::hdy_preferences_page_get_title(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_icon_name(&self, icon_name: Option<&str>) {
        unsafe {
            handy_sys::hdy_preferences_page_set_icon_name(
                self.as_ref().to_glib_none().0,
    ...
    fn set_title(&self, title: Option<&str>) {
        unsafe {
            handy_sys::hdy_preferences_page_set_title(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_icon_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_name_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut handy_sys::HdyPreferencesPage,
